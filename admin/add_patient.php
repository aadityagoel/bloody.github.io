...
<div id="page-wrapper">
	<div class="main-page">
		<div class="forms">
			<h2 class="title1">Add Patient</h2>			
			<div class="row">
...
<?php
 if(isset($_POST["sbmt"])) 
 {
 	...
 	$cn=$conn;
 	$s="insert into request(patient_name,gender,age,b_group,contact_name,email,phone,city,state,req_date,doc_name,hostpital_detail) values('" . $_POST["p_name"] ."','" . $_POST["gender"] ."','" . $_POST["age"] ."','" . $_POST["b_group"] ."','" . $_POST["c_name"] ."','" . $_POST["email"] . "','" . $_POST["mobile"] ."','" . $_POST["city"] . "','" . $_POST["state"]   ."','" . $_POST["date"]   ."','" . $_POST["d_name"]   ."','" . $_POST["address"] ."')";
 	$q=mysqli_query($cn,$s);
 	mysqli_close($cn);
 	if($q>0)
 	{
